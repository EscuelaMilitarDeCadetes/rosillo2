...
import { updateRole } from "../../features/usuarios/usersSlice.js";
import ConfirmationModal from "../common/ConfirmationModal";

/**
 * Modal para editar nombre_rol/descripcion de un RolPlataforma existente.
 *
 * apps/usuarios/views/rol_plataforma_viewset.py -> update() (PATCH).
 * No existe en el Thymeleaf original (ahí solo había alta/baja de
 * RolXUsuario, nunca edición del catálogo RolPlataforma) — es una
 * funcionalidad nueva, no una migración 1:1.
 */
