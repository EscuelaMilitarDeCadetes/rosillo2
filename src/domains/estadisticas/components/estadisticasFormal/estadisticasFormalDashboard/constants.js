// src/domains/estadisticas/components/estadisticasFormal/estadisticasFormalDashboard/constants.js
export const OPCIONES_BOOLEAN = [
  { label: 'Todas', value: null },
  { label: 'Sí', value: true },
  { label: 'No', value: false },
];

export const OPCIONES_TIPO_CONVOCATORIA = [
  { label: 'Todas', value: null },
