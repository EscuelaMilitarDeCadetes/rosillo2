...
class EtapaFlujoViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        etapa = EtapaFlujoService.crear(
            ...
            permite_paralelismo=request.data.get("permite_paralelismo", False),
            permite_reversion=request.data.get("permite_reversion", False),
            permite_salto=request.data.get("permite_salto", False),
            requiere_aprobacion=request.data.get("requiere_aprobacion", False),
            requiere_documento=request.data.get("requiere_documento", False),
            requiere_firma=request.data.get("requiere_firma", False),
            requiere_evaluacion=request.data.get("requiere_evaluacion", False),
